                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-dark" onclick="showMealDetails(${element.idMeal})"><i class="fa-solid fa-circle-info"></i></button>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12 text-center">
                            <span class="display-1 d-block" style="color : black">404</span>
        ...
        html += `
          <div id="meal-details" class="mb-5">
            <div id="meal-header" class="d-flex justify-content-around flex-wrap">
              ...
              <div id="details">
                <h3 style="color: black">${data.meals[0].strMeal}</h3>
            ...
            <div id="meal-instruction" class="mt-3">
              <h5 class="text-center" style="color: black">Instruction :</h5>
              <p style="color: black">${data.meals[0].strInstructions}</p>
            </div>
            <div class="text-center">
              <a href="${data.meals[0].strYoutube}" target="_blank" class="btn btn-outline-dark mt-3"><i class="fa-brands fa-youtube"></i></a>
            </div>
          </div>
        `;
    });
            ...
            await fetchMealsFromApi(url,arr[index]).then(data=>{
                ...
                <div id="card" class="card mb-3" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <button type="button" class="btn btn-outline-dark" onclick="showMealDetails(${data.meals[0].idMeal})"><i class="fa-solid fa-circle-info"></i></button>
                            <button id="main${data.meals[0].idMeal}" class="btn btn-outline-dark active" onclick="addRemoveToFavList(${data.meals[0].idMeal})" style="border-radius:50%"><i class="fa-solid fa-trash"></i></button>
                        </div>
                    </div>
                </div>
                `;
